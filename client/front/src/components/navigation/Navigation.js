    ...
    return(
        ...
        <div className="bg-blue-700">
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                        ...
                        <li>
                            <a href={RouteList.Main.path} className="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Home</a>
                        </li>
                        <li>
            ...
            <div className="bg-white m-auto max-w-screen-xl h-full">
                <div className="bg-white m-auto max-w-screen-xl h-[800px] w-full overflow-y-auto no-scrollbar">
                    <Routes>
                        ...
                        <Route>
                            ...
                            <Route path={RouteList.FinalResult.path} element={<RouteList.FinalResult.Component/>}/>
                        </Route>
